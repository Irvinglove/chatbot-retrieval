...
#### [Chinese version of this blog](http://blog.csdn.net/Irving_zhang/article/details/78788929)
...
This code uses Python 3 and Tensorflow >= 1.0. Clone the repository and install all required packages:
